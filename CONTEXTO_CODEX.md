...
- **Varias poses solicitadas, sin nuevas imágenes entregadas.** Usuario pidió ejemplos basados en sus referencias KomikoAI. Se intentó una adaptación romántica con toalla y después una alternativa de descanso con pijama completo usando el sprite adulto como referencia; ImageGen bloqueó ambas por contenido sexual (entrada y salida, respectivamente). No seguir reintentando estas variantes. Los frames 05 sentado y 06 acostado anteriores siguen disponibles; no hubo cambios de código ni integración.

- **Nuevo frame: Miku acostada esperando.** Generada `artwork/experiments/ending-lab/night-sequence-v2/06-miku-acostada-toalla-v1.png` a petición del usuario: Miku adulta recostada de lado en la almohada, toalla opaca cerrada y mirada afectuosa hacia Fuutarou fuera de plano; mantiene dormitorio e iluminación del frame 05. Prompt ImageGen en `06-miku-acostada-prompt.json`. Solo imagen, sin integración; se conserva el frame sentado.

- **Nueva imagen independiente: Miku sentada con toalla.** Usuario aprobó una adaptación romántica de sus referencias: Miku adulta sentada en el borde de la cama, toalla opaca cerrada, sonrisa hacia Fuutarou fuera de plano e iluminación cálida nocturna. Generada y guardada en `artwork/experiments/ending-lab/night-sequence-v2/05-miku-sentada-toalla-v1.png`; prompt en `05-miku-sentada-prompt.json`. Solo arte, sin integración ni cambios de código; versiones anteriores conservadas.

- **Última corrección: POV de Fuutarou, solo imagen.** Usuario quiere ver a Miku de espaldas DESDE SUS OJOS; Fuutarou no debe aparecer. Generado `artwork/experiments/ending-lab/night-sequence-v2/04-miku-perspectiva-fuutarou-v2.png`: Miku adulta delante del observador dentro del dormitorio, vista posterior/tres cuartos, vuelve la mirada por encima del hombro; toalla alta cerrada. Interior/cama/ventana delante, puerta en borde. Prompt ImageGen `04-miku-pov-prompt.json`. No modificar código ni integrar; versiones anteriores conservadas.

- **Frame 04 aprobado como alternativa romántica (solo imagen):** usuario aceptó mirada coqueta por encima del hombro con toalla cerrada. Generado `artwork/experiments/ending-lab/night-sequence-v2/04-miku-mirada-sobre-hombro.png`: Miku adulta de espaldas/tres cuartos, mirada hacia Fuutarou adulto sonrojado en puerta; toalla bien sujeta, sin desvestirse. Prompt ImageGen `04-miku-mirada-prompt.json`. Conservadas imágenes anteriores, sin implementación ni cambios de código.

- **Corrección de orientación v4 (solo imagen):** usuario aclaró que Miku debe darle la espalda A FUUTAROU. Creado `artwork/experiments/ending-lab/night-sequence-v2/03-miku-espaldas-a-fuutarou-v4.png`: Miku adulta de frente/tres cuartos a cámara, mirando hacia el interior, Fuutarou adulto detrás en la puerta, sonrojado. Toalla sujeta; mismo estilo y dormitorio. Prompt `miku-orientacion-v4-prompt.json`. Versiones anteriores conservadas, sin modificar código ni integrar.

- **Último ajuste, solo imagen:** usuario pidió que Miku sea más visible en el plano final. Creado con ImageGen `artwork/experiments/ending-lab/night-sequence-v2/03-fuutarou-sonrojado-miku-visible-v3.png`: plano medio más abierto, Miku adulta de espaldas nítida hasta caderas cubiertas, toalla alta sujeta; Fuutarou adulto sonrojado a la izquierda. Versión anterior conservada; prompt en `miku-visible-v3-prompt.json`. No se modificó código ni montaje.

- **Secuencia nocturna v2, solo PNG (10 septiembre):** usuario aprobó plano de Fuutarou arropando a Mitsuki y pidió sustituir los dos siguientes. `artwork/experiments/ending-lab/night-sequence-v2/` conserva copia idéntica del primer PNG y añade `02-fuutarou-abre-puerta.png` y `03-fuutarou-sonrojado-miku-espaldas.png`. ImageGen generó puerta abierta y primer plano del adulto sonrojado con Miku adulta de espaldas en primer término, toalla alta bien sujeta (adaptación comunicada; no se representa quitársela). Continuidad con sprite Fuutarou chapter_11, ropa oscura y dormitorio nocturno. Prompts junto a imágenes. V1 conservada. Sin cambios de código ni integración al ending.

- **10 de septiembre: solo imágenes, NO implementar.** Usuario pidió secuencia nocturna: Fuutarou arropa a Mitsuki y Miku espera en el dormitorio de los padres con toalla. ImageGen rechazó la versión de toalla; se comunicó y creó alternativa con bata cerrada. Tres PNG independientes en `artwork/experiments/ending-lab/night-sequence-v1/`: `01-fuutarou-arropa-mitsuki.png`, `02-miku-espera-bata.png`, `03-juntos-al-final-del-dia.png`. Padres adultos referenciados desde sprites chapter_11; Mitsuki desde CG familiar aprobado. Tercera imagen muestra pareja sentada tomada de manos. Prompts finales junto a PNG. No se modificó código, manifiestos, cronología, assets runtime ni se ejecutó build en esta tarea. No integrar estas imágenes sin nueva petición.
