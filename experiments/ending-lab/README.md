...
**Mitsuki · Contigo**: 32 planos, 147 segundos, 18 ilustraciones y 220 fotogramas de 13 clips del usuario. **Miku · Bajo la lluvia** conserva la escena de 24 segundos. Entregable Canvas interactivo, sin exportación de película ni integración al juego. Arte y títulos provisionales.
...
| --- | --- | --- |
| 00:00–00:29 | Desde que llegaste | Miku con recién nacida, despertar, brazos abiertos y besos de padres |
| 00:29–00:44 | Descubrir el mundo | Campo, primeros pasos y pequeños intentos |
| 00:44–01:35 | Los días contigo | Apego a papá, consuelo, lección de Raiha, noche, mañana siguiente y salida juntos |
| 01:35–02:27 | Todo lo que vendrá | Fuutarou enfermo, preocupación de Mitsuki, delantal de Miku, limonada, lectura, paseo, cumpleaños y cierre familiar |
...
- **Romance y esperanza**, inicial: pastel, sombras suaves, luz dorada/rosada progresiva, pétalos y bokeh discretos. Disolvencias, aperturas radiales suaves, pasos de luz y fotografías de álbum; transiciones de 1.4–1.8 s y cierre marfil de 2.3 s. El velo de lectura acompaña al texto; los títulos inferiores despejan las caras.
...
- Se usan 25 de los 33 archivos visuales de `public/images/cg/epilogue-mitsuki/background-fixed/`. Se excluyen duplicados, variantes muy similares, clips verticales con subtítulos y páginas con globos extensos. Originales conservados.
...
- Pausa, reinicio, búsqueda, selector de 32 planos, miniaturas y cuatro botones de etapa. **Mantener plano** repite un recuerdo; **Comparar original** muestra la fuente sin acabado.
...
- `mitsuki-assets.json`: alias de los 18 CG. Cambiar fuente y volver a empaquetar. Reemplazar `hero` exige rehacer máscara, fondo, párpados y coordenadas.
