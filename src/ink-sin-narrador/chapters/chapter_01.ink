=== chapter_1 ===
# sprite hide all
# scene chapter_1_context chapter_1_after_context jump
-> DONE

=== chapter_1_after_context ===
# scene chapter_1_notes chapter_1_after_notes jump
-> DONE
...
takeda: Ah, Fuutarou, my friend!
takeda: I finally got to see you.
takeda: I was simply bored of waiting.
takeda: These classes are truly something else, but I shall perse-
# sprite right takeda exhausted
# sprite hide all
# show image bg ch01-takeda-collapse-cg align 0 with fade
Takeda falls to the ground in exhaustion, still sparkling as he attempts to move his face in the dirt.
...
fuutarou: Well, it's what I was taught, it's what's keeping me alive on a budget.
